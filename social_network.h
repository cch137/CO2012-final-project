...
void free_tag_w(TagWithWeight *tag_w);
// serialize 是把 struct 轉回 string
char *serialize_tag_w(const TagWithWeight *tag_w);
// parse 是把 string 轉成 struct
TagWithWeight *parse_tag_w(const char *tag_w);

typedef double (*AlgoFunction)(double x);
