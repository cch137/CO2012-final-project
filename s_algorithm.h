...
void *SIGMOID(DBList *old_p_tags, const DBHash *likes_dict, const size_t iteration_i, const size_t iteration_n);
void *SELU(DBList *old_p_tags, const DBHash *likes_dict, const size_t iteration_i, const size_t iteration_n);
void *D_SIGMOID(DBList *old_p_tags, const DBHash *likes_dict, const size_t iteration_i, const size_t iteration_n);
void *SQUARE(DBList *old_p_tags, const DBHash *likes_dict, const size_t iteration_i, const size_t iteration_n);
